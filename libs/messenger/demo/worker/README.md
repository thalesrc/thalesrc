# Messenger Worker Demo

This demo showcases the `@telperion/messenger/worker` module, demonstrating bidirectional communication between the main thread and a Web Worker using decorators.
...
pnpm nx build messenger-worker-demo

# Preview production build
pnpm nx preview messenger-worker-demo
```
